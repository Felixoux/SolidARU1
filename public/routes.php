...
->post('/admin/category/[i:id]/[*:token]/delete', 'admin/category/delete', 'admin_category_delete')
...
->post('/admin/file/[i:id]/[*:token]/delete', 'admin/file/delete', 'admin_file_delete')
