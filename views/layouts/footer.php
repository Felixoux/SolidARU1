...
<footer class="page-footer">
    <img class="droe-sifflet" src="/img/droe.png" width="250" alt="">
    ...
    <h2 class="section-title">
        <?= $admin ? 'Bienvenue sur <strong>l\'administration</strong> du site' : 'Bienvenue sur le site de solid<strong>ARU1</strong>' ?>
    </h2>
    <ul class="footer-nav">
