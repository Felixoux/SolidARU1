...
<style type="text/css">
    ...
    .st3 {
        fill: #8C7A6D;
            ...
            <path class="st0"
                  d="M12.4,99.5c0,0-8.5-1.5-12.1,2.8c0,0-0.8,0.8,0.1,1c0.9,0.2,8.6-2.3,14.7-0.5C15.2,102.8,14.4,100.8,12.4,99.5"
            />
	...
	C15.9,104.5,15.6,102.5,13.4,101.6"/>
            <path class="st0"
                  d="M15,103.5c0,0-8.2,2.7-9.3,8.2c0,0-0.3,1.1,0.6,0.8c0.9-0.3,5.5-4.9,11.8-6.3C18,106.1,17.3,103.7,15,103.5"/>
	...
	C15.3,106.9,18,106.8,20.5,104.9"/>
            <path class="st0"
                  d="M132.7,99.7c0,0,8.5-1.4,12,3c0,0,0.8,0.8-0.1,1c-0.9,0.1-8.5-2.3-14.7-0.7C129.8,102.9,130.7,101,132.7,99.7"
            />
	...
	C129.1,104.7,129.4,102.6,131.6,101.8"/>
            <path class="st0"
                  d="M130,103.6c0,0,8.2,2.8,9.2,8.3c0,0,0.3,1.1-0.6,0.8c-0.9-0.3-5.5-5-11.7-6.5C127,106.2,127.7,103.8,130,103.6"
            />
	...
	C50.8,108.7,48.7,107.6,45.6,107.3"/>
            <path class="st0"
                  d="M48,108.9c0,0-10.6,2.6-11.6,7.1c0,0-0.3,0.9,0.8,0.6c1.1-0.3,7.1-4.7,15.2-6.1C52.4,110.5,51.2,109,48,108.9"
            />
            <path class="st0"
                  d="M51.4,109.2c0,0-9.7,3.7-9.5,8.2c0,0-0.1,0.9,1,0.5c1-0.4,6.8-5.9,14.4-8.1C57.3,109.9,54.5,109,51.4,109.2"/>
	...
	C93,110.5,94.2,109,97.4,108.9"/>
            <path class="st0"
                  d="M94,109.2c0,0,9.7,3.7,9.5,8.2c0,0,0.1,0.9-1,0.5c-1-0.4-6.8-5.9-14.4-8.1C88.1,109.9,90.9,109,94,109.2"/>
