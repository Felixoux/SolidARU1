...
<?php if (isset($_GET['sent'])): ?>
    <p style="margin-left: auto;margin-right: auto;width: var(--container-width)" class="alert alert-success">Votre commentaire a été envoyé, merci d'avoir pris le temps de nous écrire afin d'améliorer le site ;)</p>
<?php endif ?>
<?php if (isset($_GET['error'])): ?>
    <p style="margin-left: auto;margin-right: auto;width: var(--container-width)" class="alert alert-danger">Échec de l'envoi, veuillez vérifier que vos informations aies bien été entrées</p>
<?php endif ?>
<main class="contact-wrapper">
    ...
    <section class="ARU1">
        ...
        <div class="flex">
            <a class="btn-primary" style="opacity:0; cursor: pointer" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ">C</a>
